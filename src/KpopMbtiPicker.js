    ...
    <div style={s.page}>
      ...
      <div style={{ maxWidth: "640px", margin: "0 auto" }}>
        ...
        <footer style={s.footer}>
          ...
          <a href="https://buymeacoffee.com/radiantforce" target="_blank" rel="noopener noreferrer" style={s.footerLink}>buy me a photocard 🎴</a> to keep the database growing!<br />
          Outreach &amp; feedback:{" "}
