    ...
    <div style={s.page}>
        ...
        <div style={s.resultCard}>
          ...
          <div style={s.shareSection}>
            ...
            <div style={s.shareButtons}>
              <a href={`https://wa.me/?text=My%20K-pop%20MBTI%20consensus%20is%20${result}%20%E2%80%94%20${info?.name}!%20Find%20yours%20at%20https://kpopmbtipicker.com`} target="_blank" rel="noreferrer" style={{ ...s.shareBtn, background: "#25D366" }} title="Share on WhatsApp">
              ...
              <a href={`https://twitter.com/intent/tweet?text=My%20K-pop%20MBTI%20consensus%20is%20${result}%20%E2%80%94%20${info?.name}!%20Find%20yours%20at%20https://kpopmbtipicker.com`} target="_blank" rel="noreferrer" style={{ ...s.shareBtn, background: "#000" }} title="Share on X">
              ...
              <a href={`https://threads.net/intent/post?text=My%20K-pop%20MBTI%20consensus%20is%20${result}%20%E2%80%94%20${info?.name}!%20Find%20yours%20at%20https://kpopmbtipicker.com`} target="_blank" rel="noreferrer" style={{ ...s.shareBtn, background: "#000" }} title="Share on Threads">
              ...
              <button onClick={() => { navigator.clipboard.writeText("https://kpopmbtipicker.com").then(() => { setCopied(true); setTimeout(() => setCopied(false), 2000); }); }} style={{ ...s.shareBtn, background: copied ? "#ce93d8" : "#f3e5f5", border: "1.5px solid #ce93d8" }} title="Copy link">
              ...
              {navigator.share && (
                <button onClick={() => navigator.share({ title: "Kpop MBTI Picker", text: `My K-pop MBTI consensus is ${result} — ${info?.name}!`, url: "https://kpopmbtipicker.com" })} style={{ ...s.shareBtn, background: "linear-gradient(90deg, #e91e8c, #9c27b0)" }} title="Share">
      ...
      <div style={{ maxWidth: "640px", margin: "0 auto" }}>
        ...
        <footer style={s.footer}>
          ...
          <a href="https://buymeacoffee.com/radiantforce" target="_blank" rel="noopener noreferrer" style={s.footerLink}>buy me a photocard 🎴</a> to keep my Yuna and Karina collection growing!<br />
          Outreach &amp; feedback:{" "}
